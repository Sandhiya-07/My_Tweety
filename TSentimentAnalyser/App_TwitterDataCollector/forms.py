...
class HashtagForm(forms.Form):
     ...
     """
     input_hashtag = forms.CharField(label='', max_length=30, widget=forms.TextInput(attrs={"class": "form-control", 'placeholder': 'Enter a Word or Hashtag'}))
...
class NumForm(forms.Form):
    ...
    input_num = forms.CharField(label='', widget=forms.NumberInput(
        attrs={"min": 1, "max": 500, "class": "form-control", 'placeholder': 'No of tweets'}))
